...
var 苦加载数据 = [
    ...
    {name : "effect",path : "img/effect.png"},
    {name : "logo",path : "img/kaishi.jpg"},
    {name : "inputbox",path : "img/inputbox.png"},
    {name : "spiritEffect",path : "img/spiritEffect.png"},
    {name : "b_background",path : "img/beijing.jpg"},
    {name : "m_background",path : "img/m_background.png"},
    {name : "stage",path : "img/stage.png"},
    {name : "chara",path : "img/chara.png"},
    {name : "bird",path : "img/bird.png"},
    {name : "gui",path : "img/gui.png"},
    {name : "window",path : "img/shibai.jpg"},
    {name : "HP_bg",path : "img/hp_bg.png"},
    {name : "HP_value",path : "img/hp_value.png"},
];
init(1000/30, "legend", 630, 1136, 主);
function 主() {
...
游戏结束.prototype.初始 = function(){
    ...
    蚊游戏分.text = "勇气值 : " + 苦运行角色.distanceObj.value;
    蚊游戏分.color = "#93dcd1";
    蚊游戏分.size = 40;
    蚊游戏分.weight = "bolder";
    蚊游戏分.x = 200;
    ...
    var 豹再来 = new LButtonSample1(" 再来一次 ", 20, "", "#000");
    豹再来.x = 210;
    豹再来.y = 760;
    豹再来.width = 200;
    豹再来.height = 70;
    俺.overLayer.addChild(豹再来);
    豹再来.addEventListener(LMouseEvent.MOUSE_UP, 游戏开始);
};